...
class IntegrateAndFireLayer(SpikinnModule):
    ...
    def _update_potential(
        ...
        spikinn_mask_full = self._output_spikes > 0.0
        self.membrane_potentials[spikinn_mask_full] = 0.0

        unspiked_neurons = spikinn_mask_full & torch.isinf(self._spike_times)
        self._spike_times[unspiked_neurons] = current_time
        self.refractory_times[spikinn_mask_full] = self.refractory_period
