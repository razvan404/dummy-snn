...
class TestSpikeEncodingDataset:
    def test_getitem_returns_times_label(self):
        from threshold_tuning_research.datasets.base import SpikeEncodingDataset
...
class TestMnistDataset:
    ...
    def test_returns_times_label(self, mock_mnist_cls):
        ...
        from threshold_tuning_research.datasets.mnist import MnistDataset
...
class TestFashionMnistDataset:
    ...
    def test_returns_times_label(self, mock_cls):
        ...
        from threshold_tuning_research.datasets.fashion_mnist import FashionMnistDataset
...
class TestCifar10Dataset:
    ...
    def test_returns_times_label(self, mock_cls):
        ...
        from threshold_tuning_research.datasets.cifar10 import Cifar10Dataset
...
class TestFer2013Dataset:
    ...
    @patch("threshold_tuning_research.datasets.fer2013.kagglehub")
    def test_returns_times_label(self, mock_kagglehub, tmp_path):
        ...
        from threshold_tuning_research.datasets.fer2013 import Fer2013Dataset
