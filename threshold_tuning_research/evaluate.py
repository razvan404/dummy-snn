...
from threshold_tuning_research.common import load_split_data, resolve_params
from threshold_tuning_research.pipeline.datasets import dataset_names
from spikinn.evaluation import evaluate_classifier
...
from spikinn.utils.checkpoints import load_model
...
def output_filters(model) -> int:
    ...
    or a SpikinnSequential stack (the last layer carrying a num_filters)."""
    from spikinn.layers import SpikinnSequential

    if isinstance(model, SpikinnSequential):
